...
int main(void)
{
  ...
  //dummy = HAL_I2C_Master_Transmit(&hi2c2, RADIO_ADDRESS, tunePower, 4, -1);
  ...
  while (1)
  {
	  ...
	  for (i=0; i<255; i++)
	  {
		  dummy = HAL_I2C_Master_Transmit(&hi2c2, i, power_up, 1, -1);

		  if (dummy == HAL_OK)
		  	  {
		  		  ssd1306_WriteString(txt2, Font_6x8, White);
		  	  }
	  } */
